...
module.exports = {
  ...
  pgDarkPoolCurveAssetManager: pgConfig[`netId${netId}`].pgDarkPoolCurveAssetManager,
  ...
  gasLimits: {
    ...
    [jobType.PG_DARKPOOL_CURVE_EXCHANGE]: 780000,
    [jobType.PG_DARKPOOL_CURVE_LP]: 780000,
